...
export function IncomeView() {
  ...
  return (
    <div className="space-y-6">
      <div className="section-heading"><div><h2>Income estimates</h2><p className="muted">Use completed months to choose a monthly income estimate and a cash cushion.</p></div></div>
      ...
      <section className="panel p-5 sm:p-6" aria-labelledby="income-reserve-title">
        <h3 id="income-reserve-title" className="text-lg font-semibold">Income reserve</h3>
      ...
      <section className="panel overflow-hidden" aria-labelledby="income-history-title">
        <div className="p-5 sm:p-6"><h3 id="income-history-title" className="text-lg font-semibold">Completed months</h3><p className="muted mt-1 text-sm">Gaps count as zero after your ledger begins. This month is still in progress and is excluded.</p>
